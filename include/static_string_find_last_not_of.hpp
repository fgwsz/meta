...
static consteval size_type static_string_find_last_not_of(void)noexcept{
...
template<typename _TI_StaticString,typename _TI_StaticString::char_type _value,size_type _pos=size_type_inf>
static constexpr size_type static_string_find_last_not_of_v=
    static_string_find_last_not_of<_TI_StaticString,_value,_pos>();