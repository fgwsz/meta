...
static consteval size_type static_string_find_first_of(void)noexcept{
...
template<typename _TI_StaticString,typename _TI_StaticString::char_type _value,size_type _pos=0>
static constexpr size_type static_string_find_first_of_v=
    static_string_find_first_of<_TI_StaticString,_value,_pos>();